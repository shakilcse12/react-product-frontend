...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: ROUTES.USER_DASHBOARD, element: <PrivateRoute><UserDashboardPage /></PrivateRoute> },
      { path: ROUTES.ADMIN_DASHBOARD, element: <PrivateRoute><AdminDashboard /></PrivateRoute> },
    ],
  },
